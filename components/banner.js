        ...
        <div className="Banner">
            <div className="row banner-bar" style={{textAlign: 'center'}} id="banner1">
                <div className="col banner-left">
                    <p>Sign up for <a target="_blank" href="https://us02web.zoom.us/webinar/register/WN_zvOSipM-TA6bHwuBeKTVFQ">Washington STEM Advocacy Lobby Day Training</a> or <a target="_blank" href="https://www.eventbrite.com/e/washington-tech-invitational-tickets-234675168747">Washington Tech Invitationals</a></p>
                </div>
